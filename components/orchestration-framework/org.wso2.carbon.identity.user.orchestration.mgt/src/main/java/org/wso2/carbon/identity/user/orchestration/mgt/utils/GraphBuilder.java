...
package org.wso2.carbon.identity.user.orchestration.mgt.utils;

import org.apache.commons.lang.StringUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.identity.user.orchestration.mgt.Constants;
import org.wso2.carbon.identity.user.orchestration.mgt.exception.RegistrationClientException;
...
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ActionTypes.EXECUTOR;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ActionTypes.NEXT;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ComponentTypes.BUTTON;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ComponentTypes.FORM;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_ACTION_DATA_NOT_FOUND;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_COMPONENT_DATA_NOT_FOUND;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_EXECUTOR_INFO_NOT_FOUND;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_INVALID_ACTION_FOR_BUTTON;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_INVALID_ACTION_TYPE;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_INVALID_FIRST_NODE;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_MULTIPLE_STEP_EXECUTORS;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_NEXT_ACTION_NOT_FOUND;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ErrorMessages.ERROR_CODE_UNSUPPORTED_ACTION_TYPE;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.ExecutorTypes.USER_ONBOARDING;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.NodeTypes.DECISION;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.NodeTypes.PROMPT_ONLY;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.NodeTypes.TASK_EXECUTION;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.StepTypes.REDIRECTION;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.StepTypes.USER_ONBOARD;
import static org.wso2.carbon.identity.user.orchestration.mgt.Constants.StepTypes.VIEW;
import static org.wso2.carbon.identity.user.orchestration.mgt.utils.RegistrationMgtUtils.handleClientException;
